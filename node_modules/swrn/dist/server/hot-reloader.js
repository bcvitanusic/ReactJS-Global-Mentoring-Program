                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            ...
                            case 2:
                                ...
                                this.options.server.use((0, _webpackDevMiddleware2.default)(compiler, {
                                ...
                                this.options.server.use((0, _webpackHotMiddleware2.default)(compiler, {
                                        ...
                                        return _regenerator2.default.wrap(function _callee$(_context) {
                                            while (1) {
                                                switch (_context.prev = _context.next) {
                                                    case 0:
                                                        (0, _compiler.replaceStaticSource)(_this.options).then(function () {
                                                            resolve();
                                                        });
